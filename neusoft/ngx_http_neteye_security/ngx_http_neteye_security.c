...
static ngx_http_neteye_security_module_t ngx_http_neteye_security_modules[] = {
    ...
    {NGX_HTTP_NETEYE_SESSION,
        "Session Mechanism", NULL, NULL, NULL,      5, 1, 0, NULL},
    {NGX_HTTP_NETEYE_DYNWHITELIST,
        "Dynamic White list", NULL, NULL,NULL,      4, 0, 0, NULL},
    {NGX_HTTP_NETEYE_ROBOT_MITIGATION,
        "Active/Challenge", NULL, NULL, NULL,       3, 0, 0, NULL},
    {NGX_HTTP_NETEYE_IP_BEHAVIOR,
        "IP behavior", NULL, NULL, NULL,            2, 0, 0, NULL},
