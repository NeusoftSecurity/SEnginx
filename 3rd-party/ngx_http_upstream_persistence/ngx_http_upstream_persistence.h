...
typedef struct ngx_http_upstream_persistence_group_s {
    ngx_int_t                               (*sess_persistence_get)(ngx_http_request_t *r, 
                                                    struct ngx_http_upstream_persistence_group_s *group);
    void                                    (*sess_persistence_set)(ngx_http_request_t *r, 
                                                    ngx_uint_t current,
                                                    struct ngx_http_upstream_persistence_group_s *group);
    void                                    *data;
    ngx_uint_t                              timeout;
}ngx_http_upstream_persistence_group_t;

extern ngx_int_t ngx_http_upstream_persistence_get(ngx_http_request_t *r,
        ngx_uint_t peer_number,
        ngx_http_upstream_persistence_group_t *group);
extern void ngx_http_upstream_persistence_set(ngx_http_request_t *r, 
